"""Add nullable source-roll linkage to events.
...
def upgrade() -> None:
    """Add the nullable source-roll reference and its lookup index."""
    op.add_column(
        "events",
...
def downgrade() -> None:
    """Drop the source-roll reference and its index without touching history."""
