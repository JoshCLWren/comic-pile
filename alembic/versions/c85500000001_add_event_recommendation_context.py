"""Add versioned recommendation context to roll events.
...
def upgrade() -> None:
    """Add the nullable recommendation_context snapshot column to events."""
    op.add_column(
        "events",
...
def downgrade() -> None:
    """Remove the recommendation_context snapshot column from events."""
