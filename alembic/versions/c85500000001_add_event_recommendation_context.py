"""Add recommendation_context to events for weighted-roll explainability.
...
def upgrade() -> None:
    """Add the nullable versioned recommendation-context snapshot column."""
    op.add_column(
        "events",
...
def downgrade() -> None:
    """Drop the recommendation-context snapshot column."""
