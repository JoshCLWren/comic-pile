...
def test_invalid_die_size_step_down() -> None:
...
def test_invalid_die_size_step_up() -> None:
    """Raises ValueError for invalid die sizes."""
    import pytest
...
def test_dice_ladder_constant() -> None:
