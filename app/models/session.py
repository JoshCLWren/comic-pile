...
class Session(Base):
    ...
    reading_intent_confidence: Mapped[float | None] = mapped_column(Float, nullable=True)
    reading_intent_version: Mapped[str | None] = mapped_column(String(20), nullable=True)
