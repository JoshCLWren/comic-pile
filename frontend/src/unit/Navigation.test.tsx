...
test('shows Identity Inbox in desktop navigation when total is greater than 0', async () => {
  mockIdentityInboxList.mockResolvedValueOnce({ items: [{ mapping_id: 1, issue_id: 10, thread_id: 100, thread_title: 'Test', issue_number: '1', status: 'unresolved', provider: null, source_entry_summary: 'Test', why_stopped: 'None', candidates: [], created_at: null, updated_at: null }], total: 1, offset: 0, limit: 1 })
  renderWithAuth()
