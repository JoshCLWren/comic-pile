...
export const test = base.extend<TestFixtures>({
  ...
  await page.waitForSelector('[aria-label="Filter by collection"]', { state: 'visible', timeout: 30000 }).catch(() => {
    console.warn('Collection toolbar dropdown not visible within timeout, continuing anyway');
  });
