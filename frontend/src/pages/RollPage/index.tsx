    ...
    <div className="min-h-screen flex flex-col">
      <header className="flex justify-between items-center px-3 py-2 shrink-0 z-10">
        <div>
          ...
          {session?.snoozed_threads?.length > 0 && currentDie !== 20 && (
            <div className="flex items-center gap-2 mt-1">
<Tooltip content="Snoozed offset indicator">
                <span className="block modifier-badge text-[10px] font-black text-amber-500 cursor-help border-b border-dashed border-stone-600">+{session.snoozed_threads.length}</span>
              </Tooltip>
              <Tooltip content="Snoozed offset active">
                <span className="block text-[9px] text-stone-500 uppercase tracking-wider cursor-help border-b border-dashed border-stone-600">snoozed offset active</span>
              </Tooltip>
            </div>
          )}
        </div>
