...
{snoozedThreads && snoozedThreads.length > 0 && !isRatingView && (
         <div className="mt-4 md:mt-8">
           <button
             ...
             className="w-full px-4 py-2 bg-stone-500/5 border border-stone-5-stone-500/10 rounded-xl flex items-center gap-2 hover:bg-stone-500/10 transition-colors"
           >
             <span
