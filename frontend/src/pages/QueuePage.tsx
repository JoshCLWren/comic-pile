...
export default function QueuePage() {
  ...
  const [createForm, setCreateForm] = useState<FormState>(DEFAULT_CREATE_STATE)
  const [editForm, setEditForm] = useState<FormState>(DEFAULT_CREATE_STATE)
  const [editingThread, setEditingThread] = useState<Thread | null>(null)
  const [reactivateThreadId, setReactivateThreadId] = useState<string>('')
  const [issuesToAdd, setIssuesToAdd] = useState<number | string>(1)
  ...
  }, [location.state, threads, navigate, location.pathname])
  ...
  const handleDelete = (threadId: number): void => {
  ...
  const handleDragOver = (threadId: number) => (event: React.DragEvent<HTMLDivElement>): void => {
    event.preventDefault()
    setDragOverThreadId(threadId)
  }

  const handleDrop = (threadId: number) => (event: React.DragEvent<HTMLDivElement>): void => {
    event.preventDefault()
  ...
  const handleCreateSubmit = async (event: React.FormEvent<HTMLFormElement>): Promise<void> => {
    event.preventDefault()
  ...
  const openEditModal = (thread: Thread): void => {
    setEditingThread(thread)
    setEditForm({
      title: thread.title,
      format: thread.format,
      issuesRemaining: thread.issues_remaining ?? 0,
      notes: thread.notes || '',
    })
    setIsEditOpen(true)
  }

  const openReactivateModal = (thread: Thread | null): void => {
    setReactivateThreadId(thread?.id ? String(thread.id) : '')
    setIssuesToAdd(1)
    setIsReactivateOpen(true)
  }

  const handleReactivateSubmit = async (event: React.FormEvent<HTMLFormElement>): Promise<void> => {
    event.preventDefault()
  ...
  const openRepositionModal = (thread: Thread): void => {
  ...
  async function handleAction(action: 'read' | 'move-front' | 'move-back' | 'snooze' | 'edit'): Promise<void> {
  ...
  const handleRepositionConfirm = async (targetPosition: number): Promise<void> => {
        ...
        <form className="space-y-4" onSubmit={handleCreateSubmit}>
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(event: React.ChangeEvent<HTMLInputElement>) => setCreateForm({ ...createForm, title: event.target.value })}
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(event: React.ChangeEvent<HTMLInputElement>) => setCreateForm({ ...createForm, format: event.target.value })}
              className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-slate-200"
              required
            />
          </div>
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(event: React.ChangeEvent<HTMLInputElement>) => setCreateForm({ ...createForm, issuesRemaining: event.target.value })}
              className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-slate-200"
              required
            />
          </div>
          <div className="space-y-2">
            ...
            <textarea
              ...
              onChange={(event: React.ChangeEvent<HTMLTextAreaElement>) => setCreateForm({ ...createForm, notes: event.target.value })}
        ...
        <form className="space-y-4" onSubmit={handleEditSubmit}>
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(event: React.ChangeEvent<HTMLInputElement>) => setEditForm({ ...editForm, title: event.target.value })}
              className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-slate-200"
              required
            />
          </div>
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(event: React.ChangeEvent<HTMLInputElement>) => setEditForm({ ...editForm, format: event.target.value })}
              className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-slate-200"
              required
            />
          </div>
          <div className="space-y-2">
            ...
            <textarea
              ...
              onChange={(event: React.ChangeEvent<HTMLTextAreaElement>) => setEditForm({ ...editForm, notes: event.target.value })}
              className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-slate-200 min-h-[80px]"
            ></textarea>
          </div>
          <button
        ...
        <form className="space-y-4" onSubmit={handleReactivateSubmit}>
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(event: React.ChangeEvent<HTMLSelectElement>) => setReactivateThreadId(event.target.value)}
              className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-slate-200"
              required
            >
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              min="1"
              value={issuesToAdd}
              onChange={(event: React.ChangeEvent<HTMLInputElement>) => setIssuesToAdd(event.target.value)}
              className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-slate-200"
              required
            />
          </div>
