...
export default function Navigation({ onBugReportSubmit, wide = false }: NavigationProps) {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 nav-container z-40" role="navigation" aria-label="Main navigation">
        <div className={`flex h-14 items-center justify-around px-1 md:h-20 md:px-2 mx-auto ${wide ? 'max-w-(1536px)' : 'max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl'}`}>
