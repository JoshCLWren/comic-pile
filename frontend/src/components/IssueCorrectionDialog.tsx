              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="flex-1 text-center">
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full text-center text-3xl font-black bg-white/5 border border-solid border-white/20 rounded-lg py-3 px-4 text-stone-200 focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 transition-colors"
              ...
              {!allIssues.some((issue) => issue.issue_number === selectedIssueNumber.trim()) && (
                <div className="mt-4">
                  ...
                  <select
                    ...
                    disabled={isLoading}
                    className="w-full bg-stone-950/80 border border-solid border-white/20 rounded-lg py-2 px-3 text-sm text-stone-200 focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 transition-colors"
                  >
