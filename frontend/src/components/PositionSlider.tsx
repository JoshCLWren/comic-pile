 ...
 * @param props.threads - Array of all threads with {id, title, queue_position}
 * @param props.currentThread - The thread being repositioned
 * @param props.onPositionSelect - Callback when position is confirmed
 * @param props.onCancel - Callback to close without selecting
 * @returns The position slider component
 */
export default function PositionSlider({ threads, currentThread, onPositionSelect, onCancel }: PositionSliderProps) {
