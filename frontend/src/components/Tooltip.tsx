...
export default function Tooltip({ children, content }) {
  ...
  return (
    ...
    >
      {children}
      {isVisible && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 px-3 py-2 bg-[#1a1410]/95 text-stone-300 text-[10px] rounded-lg shadow-xl border border-white/10 z-50">
