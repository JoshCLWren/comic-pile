...
export interface paths {
    ...
    "/api/{path}": {
        ...
        /**
         * Api Not Found
         * @description Return a JSON 404 for unknown API routes.
         *
         *     Args:
         ...
         */
        get: operations["api_not_found_api__path__put"];
        /**
         * Api Not Found
         * @description Return a JSON 404 for unknown API routes.
         *
         ...
         *         JSON response with 404 status code.
         */
        put: operations["api_not_found_api__path__put"];
        /**
         * Api Not Found
         * @description Return a JSON 404 for unknown API routes.
         *
         ...
         *         JSON response with 404 status code.
         */
        post: operations["api_not_found_api__path__put"];
        /**
         * Api Not Found
         * @description Return a JSON 404 for unknown API routes.
         *
         ...
         *         JSON response with 404 status code.
         */
        delete: operations["api_not_found_api__path__put"];
        /**
         * Api Not Found
         * @description Return a JSON 404 for unknown API routes.
         *
         ...
         *         JSON response with 404 status code.
         */
        options: operations["api_not_found_api__path__put"];
        /**
         * Api Not Found
         * @description Return a JSON 404 for unknown API routes.
         *
         ...
         *         JSON response with 404 status code.
         */
        head: operations["api_not_found_api__path__put"];
        /**
         * Api Not Found
         * @description Return a JSON 404 for unknown API routes.
         *
         ...
         *         JSON response with 404 status code.
         */
        patch: operations["api_not_found_api__path__put"];
        trace?: never;
    };
    "/health": {
        parameters: {
